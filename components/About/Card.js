...
const Card = () => {
  return (
    ...
    // <div className="w-full max-w-sm flex flex-row sm:flex-col lg:max-w-full lg:flex-col xl:flex-col mr-2 mb-4 ">
    <div className="flex ">
      <div
        className="w-1/2 h-auto lg:h-auto lg:w-64 flex-none rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden bg-cover bg-center border border-grey-500"
